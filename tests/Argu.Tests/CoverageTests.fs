...
/// Coverage uplift: exact error-message snapshots, AppSettings edge
/// cases, and deep-subcommand mandatory-missing. These are
/// behaviour-locking tests, not exhaustive functional tests.
module ``Argu Tests Coverage Uplift`` =
